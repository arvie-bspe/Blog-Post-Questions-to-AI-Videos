...
Extract firm name, full address, and phone only when the selected article contains exact supporting text. Return an empty value when absent. Presenter gender may use only explicit pronouns or gender language in identified lawyer-description paragraphs; otherwise use unspecified. Thumbnail title must be a faithful three-to-six-word natural-case summary.
